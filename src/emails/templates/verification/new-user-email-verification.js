module.exports = function newUserEmailVerification({ username, confirmationUrl, blogTwoImage, blogTwoTitle, blogTwoDescription, blogTwoDate, blogTwoURL, blogThreeImage, blogThreeTitle, blogThreeDescription, blogThreeDate, blogThreeURL, aboutUsURL}) {
    return `
            ...
            <body>
                <center class="wrapper" data-link-color="#40C9FF" data-body-style="font-size:14px; font-family:inherit; color:#000000; background-color:#dbe2e9;">
                <div class="webkit">
                    <table cellpadding="0" cellspacing="0" border="0" width="100%" class="wrapper" bgcolor="#dbe2e9">
                    <tbody><tr>
                        <td valign="top" bgcolor="#dbe2e9" width="100%">
            ...
            </tbody></table><table class="module" role="module" data-type="divider" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="bd496724-e168-422b-9627-6d0fbd639bd4.1">
            <tbody>
                <tr>
            ...
            <tbody>
                <tr>
                <td style="padding:30px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#FFFFFF;" height="100%" valign="top" bgcolor="#FFFFFF" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 48px; color: #1b0053; font-family: inherit">Welcome, </span><span style="font-size: 48px; color: #e81cff; font-family: inherit">${username}!</span></div><div></div></div></td>
                </tr>
            </tbody>
            ...
            <tbody>
                <tr>
                <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#1B0053;" height="100%" valign="top" bgcolor="#1B0053" role="module-content"><div><div style="font-family: inherit; text-align: inherit"><span style="color: #ffffff; font-size: 15px">Welcome to </span><span style="font-size: 15px; color: #e81cff">I</span><span style="font-size: 15px; color: #e81cff"><strong>nvestant</strong></span><span style="color: #ffffff; font-size: 15px"> — we're thrilled to have you! Please click on the link below to complete your account verification and receive access to all our products. Then, check out our latest blog posts!</span></div><div></div></div></td>
                </tr>
            </tbody>
                ...
                <tbody>
                <tr>
                    <td align="center" bgcolor="#1B0053" class="outer-td" style="padding:10px 0px 40px 0px; background-color:#1B0053;">
                    <table border="0" cellpadding="0" cellspacing="0" class="wrapper-mobile" style="text-align:center;">
                        ...
                        <td align="center" bgcolor="#FFFFFF" class="inner-td" style="border-radius:6px; font-size:16px; text-align:center; background-color:inherit;">
                            <a href="${confirmationUrl}" style="background-color:#FFFFFF; border:1px solid #FFFFFF; border-color:#FFFFFF; border-radius:40px; border-width:1px; display:inline-block; font-size:15px; font-weight:bold; letter-spacing:0px; line-height:25px; padding:12px 18px 10px 18px; text-align:center; text-decoration:none; border-style:solid; font-family:inherit; width:168px; color:#000;" target="_blank">Verify Account</a>
                        </td>
                        </tr>
                        </tbody>
                    </table>
            ...
            </table><table class="module" role="module" data-type="divider" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="c5a3c312-4d9d-44ff-9fce-6a8003caeeca.2">
            <tbody>
                <tr>
                <td style="padding:0px 20px 0px 20px;" role="module-content" height="100%" valign="top" bgcolor="#1B0053">
                    <table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" height="1px" style="line-height:1px; font-size:1px;">
                    <tbody>
                        <tr>
                        <td style="padding:0px 0px 1px 0px;" bgcolor="#E81CFF"></td>
                        </tr>
                    </tbody>
                    </table>
                </td>
            ...
            <tbody>
                <tr>
                <td style="padding:30px 0px 18px 0px; line-height:20px; text-align:inherit; background-color:#1B0053;" height="100%" valign="top" bgcolor="#1B0053" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="color: #e81cff; font-size: 24px"><strong>Latest Blog Posts</strong></span></div><div></div></div></td>
                </tr>
            </tbody>
            ...
            <tbody>
                <tr>
                <td style="padding:0px 0px 10px 0px;" role="module-content" bgcolor="#1B0053">
                </td>
                </tr>
            </tbody>
            </table><table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" role="module" data-type="columns" style="padding:0px 20px 0px 20px;" bgcolor="#1B0053" data-distribution="1,1">
            <tbody>
            ...
            <tbody>
                ...
                <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;" valign="top" align="center">
                    <img class="max-width" border="0" style="display:block; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px;" width="270" alt="" data-proportionally-constrained="true" data-responsive="false" src="${blogTwoImage}" height="">
                </td>
                </tr>
            </tbody>
            </table></td>
            ...
            <tbody>
                <tr>
                <td style="padding:0px 0px 20px 0px;" role="module-content" bgcolor="#1B0053">
                </td>
                </tr>
            </tbody>
            </table><table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" role="module" data-type="columns" style="padding:0px 20px 30px 20px;" bgcolor="#1B0053" data-distribution="1,1">
            <tbody>
                <tr role="module-content">
            ...
            <tbody>
                <tr>
                <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;" valign="top" align="center">
                    <img class="max-width" border="0" style="display:block; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px; max-width:100% !important; width:100%; height:auto !important;" width="265" alt="" data-proportionally-constrained="true" data-responsive="true" src="${blogThreeImage}">
                </td>
                </tr>
            </tbody>
            </table></td>
            ...
            <tbody>
                <tr>
                <td style="padding:30px 2px 18px 2px; line-height:22px; text-align:inherit; background-color:#1B0053;" height="100%" valign="top" bgcolor="#1B0053" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 20px; color: #ffffff"><strong>Personal Finance Made Simple</strong></span></div><div></div></div></td>
                </tr>
            </tbody>
            ...
            <tbody>
                <tr>
                <td style="padding:40px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#FFFFFF;" height="100%" valign="top" bgcolor="#FFFFFF" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 15px; color: #1b0053"><strong>Learn more about </strong></span><span style="font-size: 15px; color: #e81cff"><strong>who</strong></span><span style="font-size: 15px; color: #1b0053"><strong> we are and </strong></span><span style="font-size: 15px; color: #e81cff"><strong>what</strong></span><span style="font-size: 15px; color: #1b0053"><strong> we're creating</strong></span></div><div></div></div></td>
                </tr>
            </tbody>
                ...
                <tbody>
                <tr>
                    <td align="center" bgcolor="#FFFFFF" class="outer-td" style="padding:10px 0px 40px 0px; background-color:#FFFFFF;">
                    <table border="0" cellpadding="0" cellspacing="0" class="wrapper-mobile" style="text-align:center;">
                        <tbody>
                        <tr>
                        <td align="center" bgcolor="#1B0053" class="inner-td" style="border-radius:6px; font-size:16px; text-align:center; background-color:inherit;">
                            <a href="${aboutUsURL}" style="background-color:#1B0053; border:1px solid #4d5171; border-color:#4d5171; border-radius:40px; border-width:1px; color:#ffffff; display:inline-block; font-size:15px; font-weight:normal; letter-spacing:0px; line-height:25px; padding:12px 18px 10px 18px; text-align:center; text-decoration:none; border-style:solid; font-family:inherit; width:168px;" target="_blank">About Us</a>
                        </td>
                        </tr>
                        </tbody>
                    </table>
            ...
            </table><table class="module" role="module" data-type="divider" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="bd496724-e168-422b-9627-6d0fbd639bd4.2">
            <tbody>
                <tr>
                <td style="padding:0px 0px 0px 0px;" role="module-content" height="100%" valign="top" bgcolor="">
                    <table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" height="10px" style="line-height:10px; font-size:10px;">
